...
class GeneMarkers():
    ...
    def ConstructTargets(self, y_values_train, y_values_test, normalized_train, normalized_test, combined_brain, sublist_length, dataset):
        ...
        ft_y_train.to_csv(data_dir_+"/ft_y_"+dataset+"_train.csv", header=None, index=None)
        ft_y_test.to_csv(data_dir_+"/ft_y_"+dataset+"_test.csv", header=None, index=None)
